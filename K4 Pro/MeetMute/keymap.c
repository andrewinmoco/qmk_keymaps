...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [MAC_FN] = LAYOUT_ansi_100(
        ...
        RGB_TOG,  RGB_MOD,  RGB_VAI,  RGB_HUI,  RGB_SAI,  RGB_SPI,  _______,  _______,  _______,  _______,  QK_BOOT,  _______,    _______,  _______,            _______,  _______,  _______,  _______,
        ...
        _______,  _______,  _______,                                _______,                                _______,  _______,    _______,  MIC_SILENT,  MIC_CLEAR,  MIC_ON,  _______,  _______          ),
...
//Set Matrix color based on the MUTE_STATUS var  YOU NEEED TO UDPATE THESE
